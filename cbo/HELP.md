...
* [JDBC API](https://docs.spring.io/spring-boot/3.4.7-SNAPSHOT/reference/data/sql.html)
* [MyBatis Framework](https://mybatis.org/spring-boot-starter/mybatis-spring-boot-autoconfigure/)
* [Thymeleaf](https://docs.spring.io/spring-boot/3.4.7-SNAPSHOT/reference/web/servlet.html#web.servlet.spring-mvc.template-engines)
* [Validation](https://docs.spring.io/spring-boot/3.4.7-SNAPSHOT/reference/io/validation.html)
